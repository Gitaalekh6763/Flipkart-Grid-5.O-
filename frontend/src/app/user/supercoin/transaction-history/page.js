    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="bg-gray-100 py-12 px-8">
        <div className="container mx-auto bg-white border border-gray-300 shadow-lg rounded-lg p-8 w-70">
          <h2 className="text-3xl font-semibold mb-8">SuperCoin History</h2>
          <div>
          {
                  ...
                  {transactions.map((txn, index) => (
                    ...
                    <div className={`flex justify-between items-center border-b pb-4`}>
                      <div className="flex flex-col">
                        <div className="text-black">Transactions {index + 1}</div>
                        <div className="text-gray-500">Transactions date: {txn.date}</div>
                      </div>
